...
CREATE TABLE `traitement` (
  ...
  `posologie` varchar(128) NOT NULL,
  `compteurfixe` int NOT NULL,
  `compteur` int NOT NULL,
  `quantite` varchar(45) NOT NULL,
  `ordonnance_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_traitement_ordonnance_idx` (`ordonnance_id`),
  CONSTRAINT `fk_traitement_ordonnance` FOREIGN KEY (`ordonnance_id`) REFERENCES `ordonnance` (`id`)
